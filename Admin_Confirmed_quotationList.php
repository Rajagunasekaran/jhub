...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        data:{"Option":'AdminconfirmedQuotationList'},
        success: function(data){
...
<div class="container">
    <div class="panel panel-info" >
        ...
        <div class="panel-heading" style="background:#73c20e;color:black;">
            <h3 class="panel-title" style="color:#ffffff;font-weight: bold">CONFIRMED ORDER DETAILS</h3>
        </div>
        <div class="panel-body">
            <form class="form-horizontal" id="quotationdetails">
                ...
                <div id='fileuploadform' hidden style="padding-left: 15px;">
