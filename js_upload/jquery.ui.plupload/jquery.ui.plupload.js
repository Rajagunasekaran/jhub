...
@example
	...
	<script>
		$('#uploader').plupload({
			...
			rename: true,
			sortable: true,
			flash_swf_url : '../../js_upload/Moxie.swf',
			silverlight_xap_url : '../../js_upload/Moxie.xap',
		});
	</script>
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add Btn_add_validation">' + _("Add Files") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start Btn_validation">' + _("Start Upload") + '</a>&nbsp;' +
