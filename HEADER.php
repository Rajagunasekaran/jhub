...
<head>
    ...
    <script type="text/javascript" src="jquery/jquery.1.11.3.ui-min.js"></script>
    <script type="text/javascript" src="jquery/jquery-migrate-1.2.1.min.js"></script>
    <!--TO SUPPORT JQUERY LIB VALIDATION-->
    <script type="text/javascript" src="jquery/JQuery.js"></script>
    <!--    <script type="text/javascript" src="jquery/jquery-1.9.1.js"></script>-->
    <!--    <script type="text/javascript" src="jquery/jquery-ui.1.9.1.js"></script>-->
...
<!--    <script src="http://code.jquery.com/jquery-migrate-1.2.1.min.js"></script>-->
    ...
    <style>
        ...
        .bg-image{
            ...
            /*background: #628d28 url('/images/circle.png') no-repeat;*/
        }
        .bg-rectanle{
