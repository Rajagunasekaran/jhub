...
function show_msgbox(title,msg,status,confirmation)
{
    ...
    if(status!="success")
    {
        $(".msgboxtitle").html('<i class="fa fa-warning fa-2x" style="color:#ffffff;background-color:#73c20e; "></i>'+title);
    }
    else{
        $(".msgboxtitle").html('<i class="fa fa-exclamation-circle fa-2x" style="color:#ffffff;background-color:#73c20e; "></i>  '+title);
    }
