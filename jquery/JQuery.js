...
function show_msgbox(title,msg,status,confirmation)
{
    ...
    if(status!="success")
    {
        $(".msgboxtitle").html('<i class="fa fa-warning fa-2x" style="color:#ffffff;background-color:#FF8C00; "></i>'+title);
    }
    else{
        $(".msgboxtitle").html('<i class="fa fa-exclamation-circle fa-2x" style="color:#ffffff;background-color:#FF8C00; "></i>  '+title);
    }
